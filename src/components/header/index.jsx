      ...
      <>
        <div class="header--mobile">
          <div class="header--mobile__header">
            ...
            <div
              className={`{header--mobile__menu-toggle ${
                isOpen ? "is-open" : ""
              }`}
                ...
                <div class="header--mobile__menu__close">
                  ...
                  >
                    <g clip-path="url(#clip0_128_7)">
                      <path
                        d="M38 12.8301L35.17 10.0001L24 21.1701L12.83 10.0001L10 12.8301L21.17 24.0001L10 35.1701L12.83 38.0001L24 26.8301L35.17 38.0001L38 35.1701L26.83 24.0001L38 12.8301Z"
                        fill="white"
                      />
                    </g>
                    <defs>
          ...
          <div className={`header__nav ${isOpen ? "is-open" : ""}`}>
            ...
            <ul class="header__primary-nav__list">
              <li class="header__primary-nav__list-item">
                <a class="header__primary-nav__link" href="">
                  Primary Nav Item
                </a>
              </li>
              <li class="header__primary-nav__list-item">
              ...
              <div class="header__utility-nav__flex">
                ...
                <div class="header__utility-nav__flex__flex-item">
                  <div className="header__utility-nav__search">
                    <span className="search-icon" onClick={this.openSearch}>
                      Search
                    </span>
