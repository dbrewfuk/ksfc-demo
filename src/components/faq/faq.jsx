...
const FaqCard = ({ question, answer, children }) => {
  ...
  const handleButtonClick = () => {
    ...
    const newHeight = `${contentRef.current.scrollHeight + 64}px`;
  ...
  return (
    ...
    >
      ...
      <div className="faq-card-front faq-card-inner" onclick={handleButtonClick}>
       <button
